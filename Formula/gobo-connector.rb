...
class GoboConnector < Formula
  ...
  on_macos do
    ...
    url "https://github.com/nicholaspjm/gobo-dmx-live-code/releases/download/v0.5.2/gobo-connector-macos-arm64.tar.gz" # gobo:url macos-arm64
    sha256 "1f768223ca3924de6466df6a0537accad72c2153a7550ec6cb3857ae2d0f2fcf" # gobo:sha256 macos-arm64
  end
  ...
  on_linux do
    ...
    url "https://github.com/nicholaspjm/gobo-dmx-live-code/releases/download/v0.5.2/gobo-connector-linux-x86_64.tar.gz" # gobo:url linux-x86_64
    sha256 "1e6b36dd3da3bd6cedc5014f3b9a6f1a79ff3b460b5f6b9331a4920fb9d24079" # gobo:sha256 linux-x86_64
  end
